<template>
    <footer class="px-4 divide-y dark:bg-gray dark:text-gray-100" style="background-color: whitesmoke;">
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div class="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
                    ...
                    <span class="self-center text-2xl font-semibold">LANGUAGELOOP</span>
                </a>
            </div>
